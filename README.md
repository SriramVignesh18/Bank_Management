...
3) Game Ending: The game ends when the player reaches position 100.
# Game Rules:
...
h) Counting Throws: Each dice throw is counted. However, throws of 6 are not counted toward the total throws.But, if the player is on 94 then you rolled 6,then that throw is counted.
# How to Play:
